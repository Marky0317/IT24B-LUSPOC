class TodoList {
    ...
    addTask(taskText) {
        ...
        listItem.innerHTML = `
            ...
            <span class="timestamp" style="display: block; margin-top: 0.5rem; color: black;">Date Added: ${new Date().toLocaleString()}</span>
            <div style="margin-top: 0.5rem;">
                <button class="btn btn-primary btn-sm doneButton">Done</button>
